...
Two-parent child groups join at the visible midpoint between parent cards. Multi-child groups split through a horizontal bus centered in the clear vertical gap between the parent cards and child row. Descendant rows keep a child with their own child-bearing partner or co-parent next to that co-parent; siblings outside that next-generation parentage stay outside the pair.
