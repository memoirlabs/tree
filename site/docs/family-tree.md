...
Your card receives the person object and computed relation metadata:
...
The layout wrapper owns positioning transforms. Your card owns its own visual styling and hover animations.
