...
Use `interactionMode="pan-page-scroll"` when the tree should drag-pan but vertical touch gestures should scroll the page. Use `interactionMode="scroll"` only when you want native scrollbars instead of drag panning.
