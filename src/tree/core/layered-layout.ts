import { roundTreeCoordinate } from "./edge-routing";
import type { TreeCardSize, TreeSpacing } from "./types";

export interface TreeLayeredBoxInput<Data = unknown> extends TreeCardSize {
  id: string;
  data?: Data;
  anchorIds?: string[];
